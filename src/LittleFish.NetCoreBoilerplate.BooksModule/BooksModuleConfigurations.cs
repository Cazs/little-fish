using System.Data;
using LittleFish.NetCoreBoilerplate.BooksModule.Features.DeleteBook;
using LittleFish.NetCoreBoilerplate.BooksModule.Features.GetBook;
using LittleFish.NetCoreBoilerplate.BooksModule.Features.GetBooks;
using LittleFish.NetCoreBoilerplate.BooksModule.Features.UpsertBook;
using LittleFish.NetCoreBoilerplate.BooksModule.Infrastructure;
...
namespace LittleFish.NetCoreBoilerplate.BooksModule;
