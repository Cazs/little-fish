...
namespace LittleFish.NetCoreBoilerplate.ArchitecturalTests
{
    public class CoreArchitecturalTests
    {
        ...
        public void Repositories_should_not_use_Services()
        {
            var result = _coreTypes
                .That()
                .ResideInNamespace("LittleFish.NetCoreBoilerplate.Core.Repositories")
                .ShouldNot()
                .HaveDependencyOn("LittleFish.NetCoreBoilerplate.Core.Services")
                .GetResult();
        ...
        public void Services_should_have_Service_suffix()
        {
            var result = _coreTypes
                .That()
                .ResideInNamespace("LittleFish.NetCoreBoilerplate.Core.Services")
                .And()
                .AreNotAbstract()
                .Should()
        ...
        public void Dto_should_have_Dto_suffix()
        {
            var result = _coreTypes
                .That()
                .ResideInNamespace("LittleFish.NetCoreBoilerplate.Core.Dtos")
                .Should()
