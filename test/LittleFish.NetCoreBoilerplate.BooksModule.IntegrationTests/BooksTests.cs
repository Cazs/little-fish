...
using LittleFish.NetCoreBoilerplate.BooksModule.Dtos;
using LittleFish.NetCoreBoilerplate.BooksModule.IntegrationTests.Extensions;
using LittleFish.NetCoreBoilerplate.BooksModule.IntegrationTests.Infrastructure;
using VerifyXunit;
using Xunit;

namespace LittleFish.NetCoreBoilerplate.Api.IntegrationTests
{
    [UsesVerify]
